<?php
    ...
    if (isArmstrong($testNumber)) {
        ...
        echo $testNumber . " không phải là số Armstrong."."<br>";
    }
    ...
    function hadnleInsertElement ($element, $position, $arr){
        ...
        echo "Mảng cuối" . var_dump($resultArray) . "<br/>";
    }
    ...
    echo "Mảng ban đầu" . "<br/>";
    echo var_dump($cars) . "<br/>";
    echo "Mảng sau khi loại bỏ phần tử lặp". "<br/>";
    ...
    echo "<br>";
    echo "CÂU 15: <br>Chuỗi đảo ngược của {$string} là: {$reverseString}"."<br>";
    ...
    echo "Số lượng phần tử trong mảng là: {$lengthArr}";
    ...
    // Hiển thị kết quả
    echo "<br>CÂU 18: Số lần xuất hiện của phần tử $phaneTuCanDem trong mảng là: $soLanXuatHien"."<br>";
    ...
    echo "CÂU 19: Mảng sau khi sắp xếp giảm dần: ";
    print_r($mangDuLieu);
    ...
    echo "<br>CÂU 20: Mảng sau khi thêm phần tử vào đầu và cuối: ";
    print_r($mangDuLieu);
    ...
    // Hiển thị kết quả
    echo "<br>CÂU 21: Số lớn thứ hai trong mảng là: $soLonThuHai";
...
if ($so1 <= 0 || $so2 <= 0) {
    ...
    echo "Ước số chung lớn nhất (USCLN) của $so1 và $so2 là: $uscln\n";
    echo "Bội số chung nhỏ nhất (BSCNN) của $so1 và $so2 là: $bscnn\n";
}
    ...
    function checkPrime($num)
    {
        ...
        if ($count == 0) {
            ...
            echo "$num không là số nguyên tố";
        }
    }
    checkPrime(2);
